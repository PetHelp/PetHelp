    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    enumfields.fields.EnumField(enum=pet_help.models.AnimalType, max_length=50),
                ),
                ("image", models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    enumfields.fields.EnumField(enum=pet_help.models.HelpType, max_length=20),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="pet_help.HelpOffer",
                    ),
                ),
                (
                    "related_help_request",
                    models.ForeignKey(
                        blank=True,
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="request_messages",
                        to="pet_help.HelpRequest",
                    ),
                ),
                (
                    "sender",
