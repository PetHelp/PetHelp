<template>
  <div class="page">
    <div class="container-fluid px-0">
      <div class="hero">
        ...
        <div class="hero__text">
          ...
          <p class="mt-4">Hast du ein Tier, dass schnellstmöglich durch Eintritt einer Krankheit oder Quarantäne in gute Hände zur Pflege gegeben werden muss oder du brauchst jemanden, der sich
    ...
    <div class="container pt-5 my-5 z-depth-1">
      <section class="p-md-3 mx-md-5 text-center">
        <h2 class="text-center mx-auto font-weight-bold mb-4 pb-2">Wir helfen Tierbesitzer*innen in Quarantäne</h2>
  ...
  data: function () {
    return {
      animals: [
        ...
        { id: 6, name: 'Terence', age: 8, img: 'Hund6.jpg', hometown: 'Augsburg' },
